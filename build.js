...
.orig-btn{display:inline-flex!important;align-items:center!important;gap:7px!important;margin-top:16px!important;border-bottom:1px solid var(--earth)!important;font-family:var(--mono)!important;font-size:8px!important;letter-spacing:.14em!important;text-transform:uppercase!important;color:var(--earth)!important;padding-bottom:4px!important}
.orig-btn:before{content:'文';display:inline-grid;place-items:center;width:15px;height:15px;border:1px solid var(--earth);border-radius:50%;font-size:8px;letter-spacing:0;line-height:1}
.orig-text{display:none;margin-top:14px!important;font-family:var(--serif)!important;font-size:20px!important;line-height:1.35!important;color:var(--ink)!important}
...
(function(){
  ...
  openReader = function(id){
    ...
    var orig = p.orig ? '<button class="orig-btn" onclick="$(\'origText\').classList.toggle(\'on\')">Original language</button><div id="origText" class="orig-text">'+p.orig+'</div>' : '';
