...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] bg-[#080808]/90 backdrop-blur-sm border-t border-[#1e1e1e]">
